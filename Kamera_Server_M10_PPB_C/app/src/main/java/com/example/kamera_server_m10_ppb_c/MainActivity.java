...
//                        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn_kirim_gambar = (Button) findViewById(R.id.button2);
        ...
        btn_ambil_gambar.setOnClickListener(v -> {
            ...
            imageUri = FileProvider.getUriForFile(
                    MainActivity.this,
                    "com.example.kamera_server_m10_ppb_c.provider",
                    imageFilePath);
        ...
        btn_kirim_gambar.setOnClickListener(v -> {
            if (imageFilePath != null) {
                new KirimGambarDialogFragment(imageFilePath, MainActivity.this)
                        .show(getSupportFragmentManager(), "KIRIM_GAMBAR");
            } else {
                Toast.makeText(this, "Harap ambil sebuah gambar", Toast.LENGTH_SHORT).show();
            }
        });
    }
}